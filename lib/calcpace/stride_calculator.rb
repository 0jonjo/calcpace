...
module StrideCalculator
  ...
  #
  # @example
  #   calc.stride_length('05:00', 170)             #=> 1.18 (300 s/km → 200 m/min; 200/170)
  #   calc.stride_length(300, 170)                 #=> 1.18 (numeric seconds per km)
  #   calc.stride_length('08:02', 170, unit: :mi)  #=> 1.18 (the mile equivalent of 5:00/km)
  ...
  #
  # @example
  #   calc.cadence_for_stride('05:00', 1.18)  #=> 169.5 (200 m/min / 1.18 m)
  ...
  #
  # The pace argument is read and validated exactly as PaceConverter#convert_pace
  # reads its own: a String becomes seconds through #convert_to_seconds, and
  # whatever comes out has to be positive.
  #
  ...
  def speed_meters_per_minute(pace, unit)
    ...
    pace_unit_meters(unit) / pace_seconds * 60.0
  end
end
